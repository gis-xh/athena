...
- `ResponseSchema()` 是控制输出解析器的响应模式，它有三个参数：
  - `name`：_[Required]_，关键字参数

  - `type`：响应的数据类型，比如 `boolean、number、string` 等

  - `description`：_[Required]_，是关键词对应的详细内容
...
![1 聊天机器人原理 截图](../../../assets/images/deploy-5-005.webp)
...
![2 Sequential Chains 顺序链 截图](../../../assets/images/deploy-1-001.webp)

<center>图 3-2 SimpleSequentialChain: 单个输出输出的顺序链</center>

- `SequentialChain()`：多个输入/输出

![2 Sequential Chains 顺序链 截图（2）](../../../assets/images/deploy-4-004.webp)
...
![3 Router Chain 路由链 截图](../../../assets/images/deploy-1-001.webp)
...
![1 Embedding 模型 截图](../../../assets/images/deploy-3-003.webp)
...
![1 Embedding 模型 截图（2）](../../../assets/images/deploy-7-007.webp)
...
![2 向量存储流程 截图](../../../assets/images/llm-image-20230724113409479-022.webp)
...
![2 向量存储流程 截图（2）](../../../assets/images/deploy-7-007.webp)

<center>图 3-8 查询内容与向量数据库进行匹配</center>

3、**传递给LLM：**将返回的 n 个最相似的块与输入的查询一同作为 Prompt 传递给语言模型，得到答案。

![2 向量存储流程 截图（3）](../../../assets/images/deploy-5-005.webp)

<center>图 3-9 将相似向量输入给 LLM</center>

4、Embedding 示例代码

![2 向量存储流程 截图（4）](../../../assets/images/deploy-6-006.webp)
