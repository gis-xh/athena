...
![1 安装 ipython 和 notebook 截图](../../../assets/images/dl-3-078.webp)
...
![2 运行 Jupyter Notebook 截图](../../../assets/images/dl-4-079.webp)

- 浏览器运行界面

![2 运行 Jupyter Notebook 截图（2）](../../../assets/images/dl-5-080.webp)
...
![1 安装主要依赖包 截图](../../../assets/images/dl-6-081.webp)

```shell
conda install -n krs01 scipy mkl-service libpython m2w64-toolchain
```

![1 安装主要依赖包 截图（2）](../../../assets/images/dl-7-082.webp)
...
![2 安装 TensorFlow 截图](../../../assets/images/dl-image-20230428092112240-024.webp)
...
![2 官网下载 截图](../../../assets/images/dl-image-20230428201253558-031.webp)
...
![3 安装注意 截图（2）](../../../assets/images/dl-image-20230428193829668-026.webp)

- 取消安装 Visual Studio Integration 组件，防止后续报错

![3 安装注意 截图（3）](../../../assets/images/dl-image-20230428194413913-027.webp)

- 使用默认安装路径，不做修改

![3 安装注意 截图（4）](../../../assets/images/dl-image-20230428194440733-028.webp)
...
![3 安装注意 截图（5）](../../../assets/images/dl-image-20230428203435904-035.webp)
...
![2 下载对应版本 截图](../../../assets/images/dl-image-20230428201412685-032.webp)
...
![3 安装 cuDNN 截图](../../../assets/images/dl-image-20230428202404924-033.webp)
...
![3 安装 cuDNN 截图（3）](../../../assets/images/dl-image-20230428202655263-034.webp)

## 7 配置环境变量

&emsp;&emsp;在成功安装 CUDA 后，系统会自动添加环境变量

![7 配置环境变量 截图](../../../assets/images/dl-image-20230428201014850-029.webp)
...
![7 配置环境变量 截图（2）](../../../assets/images/dl-image-20230428201050040-030.webp)
