...
- [调用 history 回调函数监控训练模型](../02-training/01-mnist.md)

- [TensorBoard 监控训练模型](../02-training/02-tensorboard.md)

上一节：[0101 测试 Keras 环境](./01-environment.md)

下一节：[0201 训练 MNIST 手写体数据集](../02-training/01-mnist.md)