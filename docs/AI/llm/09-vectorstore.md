...
![1 安装 VS2022 C/C++ 编译环境 截图](../../assets/images/llm-image-20230809095031355-005.webp)
...
![2 安装 PostgreSQL 截图](../../assets/images/llm-image-20230809100704947-006.webp)
...
![3 下载并尝试编译 pgvector 插件 截图](../../assets/images/llm-image-20230809103335181-007.webp)
...
![4 使用 VS 编译并安装插件 截图](../../assets/images/llm-image-20230807205104467-004.webp)
...
![4 使用 VS 编译并安装插件 截图（2）](../../assets/images/llm-image-20230809104346632-008.webp)
...
![4 使用 VS 编译并安装插件 截图（3）](../../assets/images/llm-image-20230809104644288-009.webp)
...
![5 在数据库中创建插件 截图](../../assets/images/llm-image-20230809105904791-010.webp)